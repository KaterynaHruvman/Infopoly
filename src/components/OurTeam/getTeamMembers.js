...
const getTeamMembers = () => {
  ...
  return [
    ...
    { id: 4, img: Kateryna, name: 'Kateryna Hruvman', job_title: 'Web/App Design', job_occupation: 'Frontend Developer', location: 'Ukraine', bio: 'Success is in the details, thats why in development I especially like to take into account every little thing in order to achieve the perfect result.bring ideas to life and see the result of work inspires me' },
