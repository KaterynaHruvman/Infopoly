...
const getTeamMembers = () => {
  ...
  return [
    ...
    { id: 11, img: Dariush, name: 'Agata Bielak', job_title: 'Finance Team', job_occupation: 'CFO', bio: 'I am ukrainian' },
    ...
    { id: 3, img: Isabela, name: 'Isabela Cinca', job_title: 'Data Science', bio: 'Bio' },
    ...
    { id: 12, img: Simon, name: 'Simon Gaudotti', job_title: 'Data Engineering', job_occupation: 'Database Developer', bio: '' },
    { id: 13, img: Katysha, name: 'Kateryna Torkachenko', job_title: 'Web/App Design', bio: 'Bio' },
  ]
}
